    ...
    <div class="container-xxl">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                ...
                @endif
                @if (Session::has('loi'))
                    <div class="alert alert-danger" role="alert">{{ Session::get('loi') }}</div>
                @endif
                {{-- @if ($errors->any())
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Fast Food</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('checkLogin') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="Nhập vào email" autofocus value="{{ old('email') }}" />
