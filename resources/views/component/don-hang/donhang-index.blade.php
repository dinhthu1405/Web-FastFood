                ...
                <form method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for=""></label>
                                <button formaction="{{ route('donHang.xoaNhieu') }}" type="submit"
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        ...
                                        <td data-target="#modal-add" data-bs-toggle="modal"
                                            data-bs-target='#modalCenter{{ $donHang->id }}'>{{ $donHang->dia_chi }}
                                        </td>
                                        ...
                                        <td class="selectBox"><input name='ids[]' type="checkbox" id="checkItem"
                                                value="{{ $donHang->id }}"></td>
                                        <!-- Modal Cảnh báo -->
                                        <div class="modal fade" id="modalCenter-Delete{{ $donHang->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="row" style="padding: 3%">
                                                        ...
                                                        <div class="col-md-2">
                                                            <button
                                                                formaction="{{ route('donHang.xoa', $donHang->id) }}"
