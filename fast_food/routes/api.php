...
Route::post('donhang/update/{id}',[HoaDonApi::class,'update']);
...
Route::post('yeuthich/create',[MonAnApi::class,'FoodFavorite']);
Route::get('yeuthich/destroy/{monAn}',[MonAnApi::class,'destroyLike']);
Route::get('magiamgia',[HoaDonApi::class,'showMaGiamGia']);
Route::post('user/update/{user}',[UserApi::class,'update']);
Route::get('user/diemmuahang/{id}',[UserApi::class,'FindUser']);
