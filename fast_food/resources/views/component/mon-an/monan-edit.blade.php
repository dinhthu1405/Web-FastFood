...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form action="{{ route('monAn.update') }}" method="post" enctype="multipart/form-data">
                {!! @csrf_field() !!}
                            ...
                            <form action="{{ route('monAn.update', ['monAn' => $monAn]) }}" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="TenMonAn" class="form-control"
                                        value="{{ $monAn->ten_mon }}" id="exampleFormControlInput1"
                                        placeholder="Tên món" />
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="user-image col-md-6 text-center">
                                            <img id="preview-image"
                                                src="{{ asset("/storage/$monAn->hinh_anhs->duong_dan") }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="DonGia" class="form-control" min="1"
                                        value="{{ $monAn->don_gia }}" id="exampleFormControlInput1"
                                        placeholder="Đơn giá" />
