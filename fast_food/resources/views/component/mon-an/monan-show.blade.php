                ...
                <form method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for=""></label>
                                <button formaction="{{ route('monAn.xoaNhieu') }}" type="submit"
                            ...
                            @foreach ($lstMonAn as $key => $monAn)
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <td class="selectBox"><input name='ids[]' type="checkbox" id="checkItem"
                                            value="{{ $monAn->id }}"></td>
                                    <!-- Modal Cảnh báo -->
                                    <div class="modal fade" id="modalCenter-Delete{{ $monAn->id }}"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="row" style="padding: 3%">
                                                    ...
                                                    <div class="col-md-2"></div>
                                                    <div class="col-md-2">
                                                        <button formaction="{{ route('monAn.xoa', $monAn->id) }}"
