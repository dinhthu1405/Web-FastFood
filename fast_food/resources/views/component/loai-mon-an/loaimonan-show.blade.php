...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="{{ route('loaiMonAn.create') }}"><button type="button" class="btn btn-success py-2 mb-4">Thêm loại món ăn</button></a>
            </div>
        </div>
            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr>
                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $loaiMonAn->ten_loai }}</strong></td>
                            <td>
                                <div class="dropdown">
