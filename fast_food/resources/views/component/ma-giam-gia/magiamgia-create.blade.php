...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><a href="{{ route('maGiamGia.index') }}"><span class="text-muted fw-light">Danh sách /</span></a> Thêm mã giảm giá</h4>
                        ...
                        <form action="{{ route('maGiamGia.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="LoaiGiamGia" id="exampleFormControlSelect1" aria-label="Default select example">
                                    ...
                                    <option value="{{ $loaiGiamGia->id }}">{{ $loaiGiamGia->ten_loai_giam_gia }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="row">
