                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0" style="background-color: #ECEEF1">
                      ...
                      @endforeach
                            ...
                            <td></td>
                            @else
                            <td> <a href="{{ route('taiKhoan.khoa_mo', $taiKhoan->id) }}" onclick="return confirm('Bạn có chắc muốn mở khóa tài khoản này')"><button type="button" id="btn-edit" class="btn btn-danger py-2 mb-4" data-target="#modal-edit" data-bs-toggle="modal" data-bs-target="#modalCenter-Edit">
