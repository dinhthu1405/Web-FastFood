...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><a href="{{ route('loaiGiamGia.index') }}"><span class="text-muted fw-light">Danh sách /</span></a> Thêm loại giảm giá</h4>
                    ...
                    <div class="card-body">
                        <form action="{{ route('loaiGiamGia.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="TenLoaiMaGiamGia" class="form-control" id="exampleFormControlInput1"
                                    placeholder="Tên loại mã giảm giá" />
                            </div>
                            <div class="row">
